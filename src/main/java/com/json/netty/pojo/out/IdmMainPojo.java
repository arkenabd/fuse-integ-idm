...
public class IdmMainPojo {
	...
	public IdmMainPojo assignValue() {
		IdmMainPojo jres = new IdmMainPojo();
		jres.setTimestamp("2016-05-31 15:45:34");
		jres.setClientID("TOKO");
		jres.setKey("abc123");
		jres.setBranchID("G001");
		jres.setCounterID("T001");
		jres.setProductType("GO-PAY");
		jres.setTrxType("CASHOUT");
		IdmDetail detail = new IdmDetail();
		detail.setTrxConfirm("12345678");
		jres.setDetail(detail);
		jres.setTimeout("");
		jres.setVersiProgram("");
		jres.setRespCode("00");
		jres.setRespDetail("SUCCESS");
		return jres;
	}
}